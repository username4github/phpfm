    ...
    <table class=\"table\">
        ...
        <form action=\"".$fm_path_info['basename']."\" method=\"post\" onsubmit=\"return test_action();\">
            <div class=\"float-left\">
                ...
                <button type=\"button\" class=\"btn\" onclick=\"remove_self()\" value=\"" . et('RemoveSelf') . "\"><i class=\"fa fa-file-remove\"></i> " . et('RemoveSelf') . "</button>
            </div>
        </form>
        </nobr>
        </td>
...
function config_form(){
    ...
    if ($reload){
        ...
        <tr><td align=right width=1>".et('FMRoot').":<td><input type=\"text\" style=\"width:392px; padding:5px 8px;\" id=\"newfmroot\" name=\"newfmroot\" autocomplete=\"off\" value=\"".html_encode($fm_root)."\" onkeypress=\"enterSubmit(event,'test_config_form(1)')\"></td></tr>
        ...
        <tr><td align=right>".et('Pass').":<td>
            <input type=\"password\" style=\"width:392px; padding:5px 8px;\" name=\"newpass\" id=\"newpass\" autocomplete=\"off\" value=\"".html_encode($show_pass)."\" onkeypress=\"enterSubmit(event,'test_config_form(1)')\">
        </td></tr>
...
function portscan_form(){
    ...
    $default_portscan_services = explode(",","FTP,SSH,TELNET,DNS,DHCP,HTTP,NETBIOS-SESSION,SNMP,LDAP,HTTPS,SMB-AD,MSSQL,ORACLE,MYSQL/MARIADB,RDESKTOP,VNC,REDIS,HTTPD-ALT");
...
function cmd_proc_open_exec($cmd, &$stdout, &$stderr) {
    ...
    $errfile = tempnam(sys_get_temp_dir(),'err');
